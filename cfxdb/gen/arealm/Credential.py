...
def CredentialStart(builder): builder.StartObject(5)
def CredentialAddAuthmethod(builder, authmethod): builder.PrependInt8Slot(0, authmethod, 0)
def CredentialAddRealm(builder, realm): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(realm), 0)
def CredentialAddAuthid(builder, authid): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(authid), 0)
def CredentialAddAuthconfig(builder, authconfig): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(authconfig), 0)
def CredentialStartAuthconfigVector(builder, numElems): return builder.StartVector(1, numElems, 1)
def CredentialAddPrincipalOid(builder, principalOid): builder.PrependStructSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(principalOid), 0)
